...
public enum Trait {
	ALIEN, ANGEL, ANIMAL, 
	BANANA, BLACKSMITH, BLOOD, BOOK, BRIGADE_CHIEF, BUG,
	CAMERA, CHAIRMAN, CLONE,
	DEAD, DELINQUENT, DETECTIVE, DIVINE, DIVINE_TREASURE, DOLL, DOUBLE_TOOTH, DRAGON, DRAMA,
	ESPER,
	FAMILIAR, FLAME, FEMALE_OUTFIT, FROG, FOREHEAD, 
	GLASSES, 
	...
	NARCISSIST, NINJA,
	OBENTO, ODD_EYE, ODDITY, ONLINE_GAME, OTAKU,
	PAJAMAS, PILOT, POLICE,
	ROYALTY, 
	...
	public static Trait parseString(String s){
		...
		switch (sanitized){
			...
			case "brigade chief": return BRIGADE_CHIEF;
			case "bug": return BUG;
			...
			case "melon bread": return MELON_BREAD;
			case "milk": return MILK;
			case "muscle": return MUSCLE;
			case "music": return MUSIC;
			case "narcissist": return NARCISSIST;
			case "ninja": return NINJA;
			case "obento": return OBENTO;
			case "odd eye": return ODD_EYE;
			case "oddity": return ODDITY;
			case "online game": return ONLINE_GAME;
			case "otaku": return OTAKU;
			case "pajamas": return PAJAMAS;
			...
			case "student council": return STUDENT_COUNCIL;
			case "tea": return TEA;
